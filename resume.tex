...
\begin{resume}                        
  ...
  \section{SKILLS}
  \textbf{Programming}:
    Javascript, \Csharp, Java (Android), Objective-C (iPhone), HTML, CSS, Clojure(Script)\\
  \textbf{Libraries}:
  ...
  \textbf{In the past I've solved problems using}:
    Oracle SQL, MySQL, Azure Table Storage/Blob Storage/Queues, a bunch of AWS services, Flutter/Dart, React.js, NHibernate, Ruby (on Rails), ColdFusion, Lucene (full text search), T4 (code generation), \LaTeX (typesetting), Oracle Database, jQuery, Angular, Knockout.js, Apache, Bash, Grunt.js, assemble.js,

  \section{EXPERIENCE}
  Freelancing. October 2016 to present
  \begin{itemize}
